...
import org.efaps.esjp.sales.report.AbstractGroupedByDate;
    ...
    extends FilteredReport
{
        ...
        extends AbstractDynamicReport
    {
        ...
        private final RuleReport_Base filterReport;

        /**
         * @param _ruleReport_Base
         */
        public DynRuleReport(final RuleReport_Base _ruleReport_Base)
        {
            ...
            throws EFapsException
        {
            ...
            final SelectBuilder selRuleDescr = new SelectBuilder(selRule).attribute(CIPayroll.RuleAbstract.Description);
         ...
         */
        public RuleReport_Base getFilterReport()
        {
